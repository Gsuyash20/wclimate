...
class LocationScreenState extends State<LocationScreen> {
  ...
  void weatherDetails(dynamic weatherData) {
    setState(() {
      ...
      feelTemp = feelTemp.toInt();
      humidity = weatherData['main']['humidity'];
      pressure = weatherData['main']['pressure'];
      weatherDescription = weatherData['weather'][0]['description'];
      double doubleVisibility = weatherData['visibility'] / 1000;
      visibility = doubleVisibility.toInt();
      double doubleSpeed = weatherData['wind']['speed'] * 3.6;
    ...
    return Scaffold(
      body: WillPopScope(
        ...
        child: SlidingUpPanel(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      TextButton(
                        onPressed: () async {
                          var weatherData = await weather.getWeathers(context);
                      ...
                      TextButton(
                        onPressed: () async {
                          ...
                          if (typedName != null) {
                            var cityData = await weather.getCityWeather(typedName, context);
                            updateUI(cityData);
                            checkDayOrNight(cityData);
                            weatherDetails(cityData);
                          }
                        },
                        child: const Icon(
                          Icons.search,
          ...
          // Use a builder function to ensure `PanelWidget` is rebuilt with updated data
